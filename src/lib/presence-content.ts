...
export const copy = {
  en: {
    ...
    session: {
      ...
      demoTimer: "The room spends 10 minutes learning your pace before voice opens.",
  ...
  el: {
    ...
    session: {
      ...
      demoTimer: "Το room περνά 10 λεπτά μαθαίνοντας τον ρυθμό σας πριν ανοίξει η φωνή.",
